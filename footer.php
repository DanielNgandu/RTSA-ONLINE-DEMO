            ...
            <div class="col-md-7 col-lg-6">
                <div class="ftco-footer-widget mb-5">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon icon-map-marker"></span><span class="text">Foxdale Office Park, Suite 207 <br>
                        Plot 609 Zambezi Road<br>
                        Roma, Lusaka</span></li>
                            <li><a href="#"><span class="icon icon-phone"></span><span class="text">+260-978884844</span></a></li>
                            <li><a href="#"><span class="icon icon-envelope"></span><span class="text">info@dczambia.com</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
