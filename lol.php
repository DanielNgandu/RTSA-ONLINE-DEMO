		                ...
		                <!--        You can switch " data-color="blue" "  with one of the next bright colors: "green", "orange", "red", "purple"             -->
		                    	...
		                    	<div class="wizard-header">
		                        	<h3 class="wizard-title">
                                        <img src="images/logo/logo.jpg" height="50" width="50">
                                        <hr><br>
								...
								<div class="wizard-navigation">
									<ul>
			                            ...
			                            <li><a href="#vehicle_tax_details" data-toggle="tab">Tax Details</a></li>
			                        </ul>
								</div>
		                        ...
		                        <div class="tab-content">
		                           <div class="tab-pane" id="personal_details">
		                            	<div class="row">
			                            	<div class="col-sm-12">
			                                	<h4 class="info-text"> 1. Let's start with the basic details.</h4>
			                            	</div>
                                            ...
                                            <div class="col-sm-6 ">
                                                ...
                                                <div class="form-group label-floating">
                                                    <label class="control-label">location_on</label>
